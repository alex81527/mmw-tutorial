function [res, az_err, el_err] = get_residual_avg_relative_response(data2, new_idx)
    ...
    random_set = new_idx;
    az_err = angle(mean(A(az_idx_set1(1),random_set)./A(az_idx_set2(1), random_set),2));
    el_err = angle(mean(A(el_idx_set1(1), random_set)./A(el_idx_set2(1), random_set),2));
